...
Source0  : https://files.pythonhosted.org/packages/49/e6/6ae0a07727e6be8500986cfb1d5ae7d665f2c5663cda2265b4d4d3e7da13/google-api-core-2.16.2.tar.gz
...
%prep
%setup -q -n google-api-core-2.16.2
cd %{_builddir}/google-api-core-2.16.2
pushd ..
cp -a google-api-core-2.16.2 buildavx2
popd
pushd ..
cp -a google-api-core-2.16.2 buildapx
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706998580
