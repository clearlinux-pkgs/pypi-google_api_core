...
Source0  : https://files.pythonhosted.org/packages/1f/cf/40aa6664a959be91a76cf99f3875f421e0307a8eb1f5d6b7dd1cc18f29a1/google-api-core-2.5.0.tar.gz
...
%prep
%setup -q -n google-api-core-2.5.0
cd %{_builddir}/google-api-core-2.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643906154
...
cp %{_builddir}/google-api-core-2.5.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_core/2b8b815229aa8a61e483fb4ba0588b8b6c491890
