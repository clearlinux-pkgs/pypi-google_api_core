...
Source0  : https://files.pythonhosted.org/packages/52/9e/c2f8458c4ca67b2b1b88b3b4b04dd5513b188eec300089ada2cb56ba8ff3/google-api-core-2.8.0.tar.gz
...
%prep
%setup -q -n google-api-core-2.8.0
cd %{_builddir}/google-api-core-2.8.0
pushd ..
cp -a google-api-core-2.8.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653333081
...
cp %{_builddir}/google-api-core-2.8.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_core/2b8b815229aa8a61e483fb4ba0588b8b6c491890
