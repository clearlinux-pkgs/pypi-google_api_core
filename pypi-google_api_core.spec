...
Source0  : https://files.pythonhosted.org/packages/08/ee/912307cf911fbc6faeefe80d1743f6b2bcf8e1e886dc707edc4d88e4461a/google-api-core-2.7.2.tar.gz
...
%prep
%setup -q -n google-api-core-2.7.2
cd %{_builddir}/google-api-core-2.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649876128
...
cp %{_builddir}/google-api-core-2.7.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_core/2b8b815229aa8a61e483fb4ba0588b8b6c491890
