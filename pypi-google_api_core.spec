...
Source0  : https://files.pythonhosted.org/packages/c2/41/42a127bf163d9bf1f21540a3bf41c69b231b88707d8d753680b8878201a6/google-api-core-2.19.1.tar.gz
...
%prep
%setup -q -n google-api-core-2.19.1
cd %{_builddir}/google-api-core-2.19.1
pushd ..
cp -a google-api-core-2.19.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719274216
