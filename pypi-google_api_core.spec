...
Source0  : https://files.pythonhosted.org/packages/c8/5c/31c1742a53b79c8a0c4757b5fae2e8ab9c519cbd7b98c587d4294e1d2d16/google_api_core-2.20.0.tar.gz
...
%prep
%setup -q -n google_api_core-2.20.0
cd %{_builddir}/google_api_core-2.20.0
pushd ..
cp -a google_api_core-2.20.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726796618
