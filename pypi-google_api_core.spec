...
Source0  : https://files.pythonhosted.org/packages/b8/b7/481c83223d7b4f02c7651713fceca648fa3336e1571b9804713f66bca2d8/google_api_core-2.24.1.tar.gz
...
%prep
%setup -q -n google_api_core-2.24.1
cd %{_builddir}/google_api_core-2.24.1
pushd ..
cp -a google_api_core-2.24.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738079789
