...
Source0  : https://files.pythonhosted.org/packages/31/c6/460b83c297c91c4f62d69aa9f04f3c5f8139a4f41c4b747c014939d5a802/google-api-core-2.19.0.tar.gz
...
%prep
%setup -q -n google-api-core-2.19.0
cd %{_builddir}/google-api-core-2.19.0
pushd ..
cp -a google-api-core-2.19.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714519150
