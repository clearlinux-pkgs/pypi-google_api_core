...
%prep
%setup -q -n google-api-core-2.7.1
cd %{_builddir}/google-api-core-2.7.1
...
cp %{_builddir}/google-api-core-2.7.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-google_api_core/2b8b815229aa8a61e483fb4ba0588b8b6c491890
