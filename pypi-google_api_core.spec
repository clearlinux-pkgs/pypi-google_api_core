...
Source0  : https://files.pythonhosted.org/packages/2b/15/7bafa5379a228ed72baf769eea5e6019a944469fe637ea0742c0351109bf/google-api-core-2.11.0.tar.gz
...
%prep
%setup -q -n google-api-core-2.11.0
cd %{_builddir}/google-api-core-2.11.0
pushd ..
cp -a google-api-core-2.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672275067
