...
Source0  : https://files.pythonhosted.org/packages/09/5c/085bcb872556934bb119e5e09de54daa07873f6866b8f0303c49e72287f7/google_api_core-2.24.2.tar.gz
...
%prep
%setup -q -n google_api_core-2.24.2
cd %{_builddir}/google_api_core-2.24.2
pushd ..
cp -a google_api_core-2.24.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742455977
