...
Source0  : https://files.pythonhosted.org/packages/fe/d6/5dd223fc5cb476ab62966849f3e6466056799dbfc005d74da800eb097f7d/google-api-core-2.10.2.tar.gz
...
%prep
%setup -q -n google-api-core-2.10.2
cd %{_builddir}/google-api-core-2.10.2
pushd ..
cp -a google-api-core-2.10.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665418990
