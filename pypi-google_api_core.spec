...
Source0  : https://files.pythonhosted.org/packages/b2/8f/ecd68579bd2bf5e9321df60dcdee6e575adf77fedacb1d8378760b2b16b6/google-api-core-2.18.0.tar.gz
...
%prep
%setup -q -n google-api-core-2.18.0
cd %{_builddir}/google-api-core-2.18.0
pushd ..
cp -a google-api-core-2.18.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711239699
