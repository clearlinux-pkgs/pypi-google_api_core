...
Source0  : https://files.pythonhosted.org/packages/81/56/d70d66ed1b5ab5f6c27bf80ec889585ad8f865ff32acbafd3b2ef0bfb5d0/google_api_core-2.24.0.tar.gz
...
%prep
%setup -q -n google_api_core-2.24.0
cd %{_builddir}/google_api_core-2.24.0
pushd ..
cp -a google_api_core-2.24.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733819011
