...
Source0  : https://files.pythonhosted.org/packages/0e/a9/d000e7562c27b3c7c037bc11dfe18093197e225dc712cc9120932e33e0ab/google-api-core-2.10.1.tar.gz
...
%prep
%setup -q -n google-api-core-2.10.1
cd %{_builddir}/google-api-core-2.10.1
pushd ..
cp -a google-api-core-2.10.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663176045
