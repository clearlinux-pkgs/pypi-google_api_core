...
Source0  : https://files.pythonhosted.org/packages/78/14/99c2514b3ccc5aad1e0776f0ae8295c9f7153aead4f41d07dd126cecdc14/google_api_core-2.19.2.tar.gz
...
%prep
%setup -q -n google_api_core-2.19.2
cd %{_builddir}/google_api_core-2.19.2
pushd ..
cp -a google_api_core-2.19.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724798143
