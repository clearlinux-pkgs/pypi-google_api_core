...
Source0  : https://files.pythonhosted.org/packages/2c/e4/56b14d35057a23cab9067dd8fb841407d05d32b5d6c7a3c66c1360e8a7c0/google-api-core-2.15.0.tar.gz
...
%prep
%setup -q -n google-api-core-2.15.0
cd %{_builddir}/google-api-core-2.15.0
pushd ..
cp -a google-api-core-2.15.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702497117
